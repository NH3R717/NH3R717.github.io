...
function intro() {
  ...
  function savedName() {
    if (person == null) {
      ...
      alert(
        person +
          ' – there you are! It looks like you are back to play "SAR–EWGCOM" again, this game must be near and dear to your heart.'
      );
    }
  }
  ...
  function userNamePrompt() {
    ...
    if (person == null || person == "") {
      alert("That's not a name. Game over, you lose...") + Environment.Exit();
    } else {
      alert(
        'Alright "' +
          person +
          "\"! You at least entered some text when prompted, looks like you can handle what's next."
      );
    }
  }
  savedName();
