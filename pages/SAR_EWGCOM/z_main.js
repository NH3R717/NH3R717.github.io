...
var protesterChoice = new ChoiceClass(
  "Protesting your government's policies is one way to make your voice felt, chose if you will be protesting and if so what type of protester you will be:\n\na. non forceful \nb. forceful \nc. not protesting",
  "Alright now, you have to enter some text to play this game, you didn't do that. Game over, you lose...",
  "You have made a valid choice.",
  "Skipping ahead are we, your choice will default to \"not protesting'.",
  "You have not made a valid choice. Game over, you lose..."
);
...
//save input variable as a new variable for use in nonforceful Police()
var forRandom = input;
...
class Location extends ChoiceClass {
  constructor() {
    super(
      "Where will you be protesting at? These are the popular locations: Wan Chai, Tsuen Wan, any MRT station, any police station, Sham Shui Po.",
      "Alright now, you have to enter some text to play this game, you didn't do that. Game over, you lose...",
      "ohh that's a selection for the last prompt, you'll be directing protest via telegram from a cargo ship anchored in Victoria Harbour.",
      "You have made a valid choice.",
      "That's not on the list, you won't cause much effect by showing up there. Your game is over, you did not win."
    );
  }
}
...
function protesterDirection() {
  ...
  if (input === "a") {
    ...
    alert(
      "Not protesting – choose another way to help your city's cause. Some examples are to learn a new skill or start a business."
    ) + alert(endMessage);
    +Environment.Exit(0);
  }
}
...
//game play alert
alert(
  "Protesting is risky business where you may be subject to police action. The likelihood of you being affected by police action depends on whether you chose to be a forceful or non forceful protester."
);
